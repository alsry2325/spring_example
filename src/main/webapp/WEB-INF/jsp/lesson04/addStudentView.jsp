...
<div class="container">
			...
			<form  method="post" action="/lesson04/add_student">
				...
				<div class="from-group">
					<label for= "yyyymmdd">폰번호</label>
					<input type= "text" id="yyyymmdd" name="phoneNumber" class= "form-control col-3" placeholder="예)20001215">
				</div>
				...
				<div class="from-group">
					...
					<input type= "text" name="dreamJob" id="dreamJob" class= "form-control col-3"  >
				</div>
